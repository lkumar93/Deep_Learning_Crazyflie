...
set(MSG_I_FLAGS "-Icrazyflie_driver:/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/srv/AddCrazyflie.srv" NAME_WE)
add_custom_target(_crazyflie_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "crazyflie_driver" "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/srv/AddCrazyflie.srv" "crazyflie_driver/LogBlock"
)

get_filename_component(_filename "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/msg/GenericLogData.msg" NAME_WE)
add_custom_target(_crazyflie_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "crazyflie_driver" "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/msg/GenericLogData.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/msg/LogBlock.msg" NAME_WE)
add_custom_target(_crazyflie_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "crazyflie_driver" "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/msg/LogBlock.msg" ""
)

get_filename_component(_filename "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/srv/UpdateParams.srv" NAME_WE)
add_custom_target(_crazyflie_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "crazyflie_driver" "/home/avinash/Deep_Learning_Crazyflie/src/crazyflie_ros_pkg/crazyflie_driver/srv/UpdateParams.srv" ""
)
