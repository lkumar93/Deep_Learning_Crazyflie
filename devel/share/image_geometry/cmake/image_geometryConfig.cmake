...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/avinash/Deep_Learning_Crazyflie/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/avinash/Deep_Learning_Crazyflie/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/avinash/Deep_Learning_Crazyflie/install)
...
if(NOT "/home/avinash/Deep_Learning_Crazyflie/src/vision_opencv/image_geometry/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/avinash/Deep_Learning_Crazyflie/src/vision_opencv/image_geometry/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avinash/Deep_Learning_Crazyflie/src/vision_opencv/image_geometry/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
